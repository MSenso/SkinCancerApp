...
from schemas.answer import AnswerModel, AnswerCreate, AnswerUpdate
...
@router.get("/{answer_id}", response_model=AnswerModel)
...
@router.get("/", response_model=List[AnswerModel])
